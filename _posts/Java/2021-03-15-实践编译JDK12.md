...
参考[在线版](https://openjdk.java.net/groups/build/doc/building.html)，源码的`doc/building.html`，[Community builds using source code from OpenJDK project](https://github.com/ojdkbuild/ojdkbuild)
